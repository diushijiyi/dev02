...
public class Swagger2Config {
    ...
    private List<Parameter> jwtToken() {
        ...
        Parameter tokenParameter = builder.name("token")
                // 描述
                .description("token令牌")
                // 数据类型
    ...
    private ApiInfo apiInfo_Gpy() {
        return new ApiInfoBuilder()
                .title("Gpy的模块")
                .description("Gpy的代码实现~")
                .version("2.0")
                .contact(new Contact("Gpy", "https://github.com/Gpy", "Gpy@qq.com"))
                .build();
    }
